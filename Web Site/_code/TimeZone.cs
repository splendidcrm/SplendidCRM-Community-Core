...
namespace SplendidCRM
{
	...
	public class TimeZone
	{
		...
		public TimeZone CreateTimeZone(Guid gTIMEZONE)
		{
...
// 12/16/2021 Paul.  Logging this error is not a requirement.  Adding reference to SplendidError could cause circular references issue. 
#if false
