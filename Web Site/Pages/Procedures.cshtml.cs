...
namespace SplendidCRM.Pages
{
	public class ProceduresModel : PageModel
	{
		...
		public ProceduresModel(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor, IMemoryCache memoryCache, HttpSessionState Session, Security Security, SplendidError SplendidError)
		{
