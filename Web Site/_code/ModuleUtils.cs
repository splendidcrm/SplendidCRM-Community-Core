...
#pragma warning restore CS1998
			...
			public void Start()
			{
				try
				{
					SplendidError.SystemMessage("Warning", new StackTrace(true).GetFrame(0), "Undelete Start: " + DateTime.Now.ToString() );
					if ( this.arrID != null && this.arrID.Length > 0 )
					{
						...
						{
							con.Open();
							string sTABLE_NAME = Modules.TableName(this.sMODULE_NAME);
				...
				{
					SplendidError.SystemMessage("Warning", new StackTrace(true).GetFrame(0), "Undelete End: " + DateTime.Now.ToString() );
				}
			}
		}
