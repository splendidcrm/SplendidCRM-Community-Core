...
{
	// 06/29/2023 Paul. EmailImages are not authorized. 
	public class EmailImageModel : PageModel
	{
		...
		public EmailImageModel(HttpSessionState Session, Security Security, Sql Sql, SplendidError SplendidError)
		{
