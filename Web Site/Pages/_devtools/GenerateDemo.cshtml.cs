...
namespace SplendidCRM.Pages._devtools
{
	public class GenerateDemoModel : PageModel
	{
		...
		public GenerateDemoModel(IHttpContextAccessor httpContextAccessor, HttpSessionState Session, Security Security, Sql Sql, SqlProcs SqlProcs, SplendidError SplendidError, SplendidCache SplendidCache, SplendidInit SplendidInit)
		{
